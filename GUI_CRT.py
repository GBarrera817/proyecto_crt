...
class Application:
	def __init__(self):
		...
		self.lbl_tban_hist = ttk.Label(self.frame, text='Histórico Tranbank', padding=(5, 5))
	...
	def cargar_tbank_historico(self):
		...
		self.file_tbank_historico = file

		df_tbank = pd.read_excel(self.file_tbank_historico, sheet_name=None, skiprows=1)
...
#Bsale
# CAMBIAR RUTA
xlsx_bsale = pd.read_excel('/content/drive/MyDrive/proyecto_crt/datos/docSearchExport_cc0f2b54bf6e4b085d07fc2bdcdabf5fd73b1843.xlsx', header=11, sheet_name=None)
...
# CARGAR ARCHIVO DE TBANK EN FORMATO CSV
df_tranbank = pd.read_csv('/ruta/al/archivo/credito.csv')
...
#df_tranbank = archivo que se le completa a Monica
